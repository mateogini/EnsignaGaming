        ...
        <footer>
            <div >
                <ul className='list'>
                   ...
                   <Link to={`/`}> <li>Ventas Corporativas</li></Link>
                   <Link to={`/`}> <li>Términos y Condiciones</li></Link>
                   <Link to={`/`}> <li>Políticas de Privacidad</li></Link>
                   <Link to={`/`}> <li>Garantias y Devoluciones</li></Link>
                </ul>
            </div>
            ...
            <div className='footer2'>
                ...
                <span>Página desarrollada por Mateo Viera como parte de una entrega para el curso de React en CoderHouse.</span>
            </div>
